...
$$
F_z = \left(-\underset{S}{\int} \overset{\leftrightarrow}{\Pi}\cdot\mathrm{d}\vec{S}\right)_z = -2\pi r_p^2 \int_0^\pi\left( \rho v_z v_r + p \cos\theta\right)_{r=r_p}\,\mathrm{d}\theta \,.
$$
